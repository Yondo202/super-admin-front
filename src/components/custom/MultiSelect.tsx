   ...
   (
      ...
      return (
         ...
         >
            <div
               className={cn(
                  'group rounded-md border bg-card-bg border-border hover:bg-hover-bg px-3 py-2 text-sm focus-within:ring-1 focus-within:ring-primary focus-within:border-primary',
                  className,
               )}
            >
               <div className="flex flex-wrap gap-1">
                  {selected.map((option) => {
                     return (
                        <Badge
                           ...
                           variant="secondary"
                           className={cn(
                              'data-[disabled]:bg-muted-bg data-[disabled]:text-muted-text data-[disabled]:hover:bg-muted-bg',
                              'data-[fixed]:bg-muted-bg data-[fixed]:text-muted-text data-[fixed]:hover:bg-muted-bg',
                              badgeClassName,
                           )}
                        ...
                        >
                           ...
                           >
                              <IoIosClose className="h-4 w-4 text-lg text-muted-text hover:text-text" />
                           </button>
                        </Badge>
                     );
                  })}
                  ...
                  <CommandPrimitive.Input
                     ...
                     className={cn('ml-1 flex-1 bg-transparent outline-none font-normal placeholder:text-muted-text/70', inputProps?.className)}
                  />
               </div>
            </div>
            <div className="relative mt-2">
               {open && (
                  <CommandList className="absolute top-0 z-50 w-full rounded-md border bg-card-bg shadow-md outline-none animate-in">
                     {isLoading ? (
                        <>{loadingIndicator}</>
                     ) : (
                        <>
