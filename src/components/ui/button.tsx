...
export const buttonVariants = cva(
  "inline-flex items-center gap-2 text-text justify-center whitespace-nowrap rounded-md text-sm font-medium transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-slate-950 disabled:pointer-events-none disabled:opacity-50 dark:focus-visible:ring-slate-300",
  {
    variants: {
      variant: {
        default:
          "bg-primary text-[#FFF] shadow hover:bg-primary/80",
        destructive:
          "bg-red-500 text-slate-50 shadow-sm hover:bg-red-500/90 dark:bg-red-900 dark:text-slate-50 dark:hover:bg-red-900/90",
        outline:
          "border border-border bg-card-bg text-primary shadow-sm hover:bg-slate-100 hover:bg-hover-bg",
        secondary:
